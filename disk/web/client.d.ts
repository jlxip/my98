export interface DiskState {size:number;disk_id:number[];dirty_bytes:number;dirty_sectors:number;cache_bytes:number;revision:number;}
...
export class Slop86Disk {
 ...
 readStats():Promise<{readBytes:number;readCalls:number}>;

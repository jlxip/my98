...
return createServer(async(req,res)=>{
    try {
        ...
        if(!file.startsWith(repo)||![/^\/build\/disk\//,/^\/build\/(libv86.mjs|v86.wasm|v86-fallback.wasm)$/,/^\/bios\//,/^\/src\/browser\//,/^\/slop86\/src\//,/^\/disk\/browser-tests\//,/^\/index.html$/,/^\/win98.css$/].some(re=>re.test(url.pathname))) {res.writeHead(404).end();return;}

...
export class Slop86Disk {
 ...
 openReadOnly(options:{cid:string;readKey:string;gateway?:string;servers?:QueryServer[];onlyLocalhost?:boolean;prefetch?:PrefetchOptions;preloadState?:boolean;stateTransport?:"auto"|"blocks";persistentCache?:{state?:boolean;loadProfile?:boolean}}):Promise<DiskState>;

...
if(process.argv.length!==3)throw Error('Usage: node src/disk/browser-tests/remote-boot.mjs <Win98 fixture.json>');
...
try {
    ...
    const child=spawn(process.execPath,[resolve(repo,'src/disk/browser-tests/boot.mjs'),path],{cwd:repo,stdio:'inherit'});

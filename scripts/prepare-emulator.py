...
patch = root / "patches/slop86.patch"

def git(*args):
    return subprocess.check_output(["git", "-C", str(source), *args])

if git("status", "--porcelain", "--untracked-files=no").strip():
    raise SystemExit("The slop86 submodule must be clean; keep application changes in patches/slop86.patch")
...
for name in ("libv86.js", "libv86.mjs", "v86_all.js", "v86.wasm", "v86-fallback.wasm"):
...
print("Emulator sources: " + revision + " + patches/slop86.patch")
